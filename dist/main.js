...
function Task(title, priority, description, status,dueDate, createdDate){
    ...
    if (createdDate){
        ...
        this.createdDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'yyyy-MM-dd');
    }
}
...
const fireEventListeners = () => {
    ...
    taskForm.addEventListener('submit', (e)=> {
        ...
        console.log(_index_js__WEBPACK_IMPORTED_MODULE_1__.ProjectsList.findTask(taskTitle)[2]);
